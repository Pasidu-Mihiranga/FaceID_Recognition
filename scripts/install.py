...
def install_pytorch():
 ...
 print("[FAIL] PyTorch installation failed")
 return False
...
def install_face_recognition_libraries():
 ...
 if install_package(package):
 print(f"[OK] {lib_name} installed successfully")
 installed.append(lib_name)
 else:
 print(f"[WARN] {lib_name} installation failed (optional)")
...
def install_dlib():
 ...
 print("[OK] dlib installed successfully")
 return True
 
 print("[WARN] dlib installation failed")
...
def test_imports():
 ...
 print(f"[WARN] {name} import failed (optional)")
...
def main():
 ...
 print(f"Core dependencies: {'[OK]' if not failed_core else '[FAIL]'}")
 print(f"TensorFlow: {'[OK]' if tf_success else '[FAIL]'}")
 print(f"PyTorch: {'[OK]' if torch_success else '[FAIL]'}")
 print(f"Face recognition libs: {len(face_libs)}/{4} installed")
 print(f"Dlib: {'[OK]' if dlib_success else '[FAIL]'}")
 print(f"Critical imports: {'[OK]' if critical_ok else '[FAIL]'}")
 ...
 if optional_count >= 3:
 print("[OK] Most optional libraries installed - full functionality available!")
 else:
 print("[WARN] Some optional libraries missing - limited functionality.")
